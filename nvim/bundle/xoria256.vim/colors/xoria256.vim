...
hi CursorColumn                           ctermbg=237 guibg=#444444
...
hi LineNr       ctermfg=238 guifg=#6e6e6e ctermbg=233 guibg=#121212
hi CursorLineNr ctermfg=15  guifg=#6e6e6e ctermbg=214 guibg=#ffaf00
